      ...
      <main className="h-full font-inter">
        ...
        <div className="mainCard">
          <div className="border w-full border-gray-200 bg-white py-4 px-6 rounded-xl">
            <div className=" py-5 ">
              <h1 className=" text-custom-2 font-bold text-2xl">لیست خدمات</h1>
              <p className="py-5">
                در این قسمت لیست خدمات سالن زیبایی را مشاهده می‌کنید.
              </p>
            </div>
            <div className="md:flex ">
              ...
              <div className="mb-5 justify-center items-center flex">
                ...
                {showPopup && <ServiceFormPopup onClose={handleClosePopup} />}
              </div>
            </div>

            <ServiceTable dataHeader={dataHeader} />
          </div>
        </div>
      </main>
    </>
