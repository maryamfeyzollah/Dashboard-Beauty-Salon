    ...
    <main className="h-full font-inter">
      ...
      <div className="mainCard">
        <div className="border w-full border-gray-200 bg-white py-4 px-6 rounded-xl">
          <div className=" py-5 ">
            <h1 className=" text-custom-2 font-bold text-2xl">اطلاعات تماس</h1>
          </div>
          <div className="social-buttons flex flex-col">
            <div className="flex gap-3">
              <FaLocationDot className="text-custom-2" />
              سعادت آباد سرو‌غربی نرسیده به میدان کتاب
            </div>
