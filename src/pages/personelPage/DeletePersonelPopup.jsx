const DeletePersonelPopup = ({ title, message, onConfirm, onCancel }) => {
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-10 ">
      <div className="bg-white p-5 m-5 rounded-xl shadow-xl ">
        ...
        <div className="mt-6  justify-end flex gap-3">
          <button
            className="bg-red-500 hover:bg-red-600 text-white font-bold p-3 rounded mr-2"
            onClick={onConfirm}
          >
            حذف
          </button>
...
export default DeletePersonelPopup;
