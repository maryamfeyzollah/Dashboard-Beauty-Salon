...
import { searchPersonels } from "../../reducers/personelsSlice";

const PersonelsSearch = () => {
  ...
  const handleChange = (e) => {
    if (e.target) {
      ...
      dispatch(searchPersonels(value));
    } else {
      setScButton(false);
    }
  };
...
export default PersonelsSearch;
